const TickerBySectorDefs = `#graphql
scalar DateTime
scalar JSON
enum Type {
  QUARTERLY
...
earningYieldY            :    Float
  ...
  type Query {
    TickerBySector(skip:Int, take:Int, industryName : String, sectorName:String): TickerBySector
  }
...
module.exports = TickerBySectorDefs;
